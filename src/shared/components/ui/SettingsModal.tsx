      ...
      {isOpen && (
        ...
        <div className="modal-body">
          ...
          <div className="settings-section">
            ...
            <div className="settings-row">
              <div className="setting-info">
                ...
                <span className="setting-description">
                  Prevent incomplete tasks from automatically moving to today
                </span>
              </div>
            ...
            <div className="settings-row" style={{ marginTop: 'var(--space-4)' }}>
              <div className="setting-info">
                ...
                <span className="setting-description">
                  Show the chatbot button in the bottom right corner
                </span>
              </div>
              <label className="toggle-switch">
                <input
            ...
            <div className="settings-row" style={{ marginTop: 'var(--space-4)' }}>
              <div className="setting-info">
                ...
                <span className="setting-description">
                  Show the music player button in the bottom right corner
                </span>
              </div>
              <label className="toggle-switch">
                <input
          ...
          <div className="settings-section">
            ...
            {/* Background Pattern (Dark Solid only) */}
            {theme === 'dark-solid' && (
              <div className="settings-row vertical">
                <div className="setting-info">
                  <span className="setting-label">Background Pattern</span>
                  <span className="setting-description">
                    Use a custom grid pattern or your wallpaper image
                  </span>
                </div>
                <div className="view-toggles">
                  <button
                    className={`view-btn ${useGridBackground ? 'active' : ''}`}
                    onClick={() => onUseGridBackgroundChange(true)}
                  >
                    Dotted Grid
                  </button>
                  <button
                    className={`view-btn ${!useGridBackground ? 'active' : ''}`}
                    onClick={() => onUseGridBackgroundChange(false)}
                  >
                    Image Wallpaper
                  </button>
                </div>
            ...
            <div className="settings-row vertical">
              <div className="setting-info">
                ...
                <span className="setting-description">
                  Adjust overlay opacity for readability ({dimLevel}%)
                </span>
              </div>
            ...
            <div className="settings-row vertical">
              <div className="setting-info">
                ...
                <span className="setting-description">
                  Adjust blur and transparency of UI panels ({glassIntensity}%)
                </span>
              </div>
              <div className="slider-container">
                <input
            ...
            <div className="settings-row vertical">
              <div className="setting-info">
                ...
                <span className="setting-description">
                  Adjust light bending and color saturation effects ({glassRefraction}%)
                </span>
              </div>
              <div className="slider-container">
                <input
          ...
          <div className="settings-section">
            ...
            <div className="settings-row">
              <div className="setting-info">
                ...
                <span className="setting-description">
                  Download a backup of your progress and settings
                </span>
              </div>
            ...
            <div className="settings-row">
              <div className="setting-info">
                ...
                <span className="setting-description">
                  Permanently wipe all local progress and remote sync backups
                </span>
              </div>
              <button
          ...
          <div className="settings-section">
            ...
            <div className="settings-row">
              <div className="setting-info">
                ...
                <span className="setting-description">
                  Use this if the app does not update after tapping "Update now".
                </span>
              </div>
              <button
                className="action-btn outline small"
            ...
            {!isConfigured ? (
              <div className="settings-row vertical">
                <div className="setting-info">
                  ...
                  <span className="setting-description">
                    Missing Supabase environment configuration for this build.
                  </span>
                </div>
              </div>
            ) : (
          ...
          <div className="settings-section">
            ...
            <div className="settings-row">
              <div className="setting-info">
                ...
                <span className="setting-description">
                  Review latest updates before and after each release
                </span>
              </div>
