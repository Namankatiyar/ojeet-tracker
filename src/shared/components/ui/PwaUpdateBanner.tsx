    ...
    return (
        <div className="pwa-update-banner" role="status" aria-live="polite">
            ...
            <div className="pwa-update-actions">
                <button type="button" className="action-btn primary small" onClick={handleUpdate} disabled={isUpdating}>
                    {isUpdating ? 'Updating...' : 'Update now'}
                </button>
                <button type="button" className="action-btn outline small" onClick={dismissUpdateNotice} disabled={isUpdating}>
                    Later
                </button>
            </div>
        </div>
