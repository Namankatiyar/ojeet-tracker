  ...
  return createPortal(
    <AnimatePresence>
      {isOpen && (
        ...
        >
          <motion.div
            className="color-picker-modal motion-animated"
        ...
        <div className="color-picker-content">
          ...
          <div
            ...
            ref={satLightRef}
            style={{
              background: `linear-gradient(to bottom, white, transparent, black), linear-gradient(to right, #808080, hsl(${hue}, 100%, 50%))`,
            }}
          ...
          >
            <div className="hue-slider-handle" style={{ left: `${(hue / 360) * 100}%` }} />
          </div>
