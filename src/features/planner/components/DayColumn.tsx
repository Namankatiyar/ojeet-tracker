              ...
              >
                <div className="task-left">
                  <div className="task-title">
                    ...
                    {isOverdue(task) && !task.wasShifted && (
                      <span className="pending-tag">
                        <ClockAlert size={13} /> Pending
                      </span>
                    )}
                    {task.wasShifted && !task.completed && (
                      <span className="delayed-tag">
                        <Hourglass size={13} /> Delayed
                      </span>
                    )}
                  </div>
                ...
                <div className="task-right">
                  <div
                    className={`task-meta ${task.wasShifted && !task.completed ? 'delayed' : ''} ${task.completed ? 'completed-time' : ''}`}
                  >
                    <Clock size={13} />
