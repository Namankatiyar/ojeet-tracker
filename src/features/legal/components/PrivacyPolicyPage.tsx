    ...
    <section className="legal-page">
      <div className="legal-card glass-panel">
        ...
        <div className="legal-content">
          ...
          <h2>Data Sharing</h2>
          <p>
            We do not share or sell your personal data to any organization. Your data is only used
            to operate sync and app functionality.
          </p>

          <h2>Backups and Imports</h2>
          <p>
            Backup files may contain personal study information. Keep exported files secure and
            import only trusted backups.
          </p>

          <h2>Your Control</h2>
          <p>
            You can modify or remove your data at any time by editing entries in the app, importing
            another backup, or clearing browser storage.
          </p>

          <h2>Contact</h2>
          <p>
            For policy-related questions, please contact the app maintainer through the project
            repository.
          </p>
        </div>
